...
Статическая версия сайта [pocketdoctor.medclever.com](http://pocketdoctor.medclever.com),
...
- Источник истины — `version.md` в корне (одна строка, semver). Текущая версия — `0.1.0`;
  `1.0.0` — момент переезда и замены старого сайта.
